...
let finalNode = currentNode; //DOESNT RETURN CORRECT STEP COUNT
function findSmallestRoute(baseSpiralNode) {
	...
	while (!found) {
		...
		else if (currentNode.left !== null && currentNode.left.value < min) {
			min = currentNode.left.value;
			currentNode = currentNode.left;
		}
		else if (currentNode.up !== null && currentNode.up.value < min) {
			min = currentNode.up.value;
			currentNode = currentNode.up;
		}
		else if (currentNode.down !== null && currentNode.down.value < min) {
...
console.log(findSmallestRoute(finalNode));

//console.log(util.inspect(firstNode, {showHidden: false, depth: null}));